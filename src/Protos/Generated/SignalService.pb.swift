...
struct SignalServiceProtos_DataMessage {
  ...
  var messageTimer: UInt32 {
    get {return _messageTimer ?? 0}
    set {_messageTimer = newValue}
  }
  /// Returns true if `messageTimer` has been explicitly set.
  var hasMessageTimer: Bool {return self._messageTimer != nil}
  /// Clears the value of `messageTimer`. Subsequent reads from it will return its default value.
  mutating func clearMessageTimer() {self._messageTimer = nil}

  var aiBotState: Bool {
    get {return _aiBotState ?? false}
    set {_aiBotState = newValue}
  }
  /// Returns true if `aiBotState` has been explicitly set.
  var hasAiBotState: Bool {return self._aiBotState != nil}
...
struct SignalServiceProtos_SyncMessage {
  ...
  var messageTimerRead: SignalServiceProtos_SyncMessage.MessageTimerRead {
    get {return _messageTimerRead ?? SignalServiceProtos_SyncMessage.MessageTimerRead()}
    set {_messageTimerRead = newValue}
  }
  /// Returns true if `messageTimerRead` has been explicitly set.
  var hasMessageTimerRead: Bool {return self._messageTimerRead != nil}
  /// Clears the value of `messageTimerRead`. Subsequent reads from it will return its default value.
  mutating func clearMessageTimerRead() {self._messageTimerRead = nil}
  ...
  fileprivate var _padding: Data? = nil
  fileprivate var _messageTimerRead: SignalServiceProtos_SyncMessage.MessageTimerRead? = nil
}
...
extension SignalServiceProtos_SyncMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 11: try decoder.decodeSingularMessageField(value: &self._messageTimerRead)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._messageTimerRead {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 11)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: SignalServiceProtos_SyncMessage, rhs: SignalServiceProtos_SyncMessage) -> Bool {
    ...
    if lhs._messageTimerRead != rhs._messageTimerRead {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
