...
@objc public class SSKProtoDataMessageAITrainModeInfo: NSObject {
    ...
    @objc public class func builder() -> SSKProtoDataMessageAITrainModeInfoBuilder {
        return SSKProtoDataMessageAITrainModeInfoBuilder()
    }

    // asBuilder() constructs a builder that reflects the proto's contents.
    @objc public func asBuilder() -> SSKProtoDataMessageAITrainModeInfoBuilder {
        let builder = SSKProtoDataMessageAITrainModeInfoBuilder()
...
@objc public class SSKProtoDataMessage: NSObject {
    ...
    @objc public class SSKProtoDataMessageBuilder: NSObject {
        ...
        @objc public func setAiBotState(_ valueParam: Bool) {
    ...
    @objc public var aiBotState: Bool {
        return proto.aiBotState
    }
    @objc public var hasAiBotState: Bool {
        return proto.hasAiBotState
    }
