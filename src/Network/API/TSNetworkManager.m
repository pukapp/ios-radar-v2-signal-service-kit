               ...
               failure:(TSNetworkManagerFailure)failure
{
    ...
    [self multipartFormRequestWithMethod:request.HTTPMethod url:requestURLString parameters:request.parameters constructingBodyWithBlock:block progress:uploadProgress success:success failure:failure];
}

- (NSURLSessionDataTask *)multipartFormRequestWithMethod:(NSString *)method
                                                 ...
                                                 failure:(void (^)(NSURLSessionDataTask *task, NSError *error))failure
{
    ...
    NSMutableURLRequest *request = [self.sessionManager.requestSerializer multipartFormRequestWithMethod:method URLString:[[NSURL URLWithString:URLString relativeToURL:self.sessionManager.baseURL] absoluteString] parameters:parameters constructingBodyWithBlock:block error:&serializationError];
            ...
            failure:(TSNetworkManagerFailure)failure
{
    ...
    dispatch_async(NetworkManagerQueue(), ^{
        [self makeRequestSync:request completionQueue:completionQueue constructingBodyWithBlock:block progress:uploadProgress success:success failure:failure];
    });
}
                ...
                failure:(TSNetworkManagerFailure)failureParam
{
    ...
    [sessionManager performRequest:request canUseAuth:canUseAuth constructingBodyWithBlock:block progress:uploadProgress success:success failure:failure];
}
